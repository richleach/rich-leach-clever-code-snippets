    ...
    return (
        ...
        <div className="min-h-screen m-4">
            ...
            <div className="shadow-md bg-white" style={{
                ...
                This form uses client and server side validation/processing. With the help of the Mantine form controls a user fills out and submits the form which immediately invokes the handleSubmit() method. After a quick check for errors on the client side, the server action submitForm() is invoked and the form data is processed on the server. At the moment a simple console.log() is spitting back the submitted form data, but in the next post I&apos;ll configure the database query and take this thing end-to-end.
            </div>
